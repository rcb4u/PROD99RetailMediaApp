...
public class DoctorHolder extends GroupViewHolder {
    ...
    public void setGenreTitle(ExpandableGroup genre) {
        if (genre instanceof Doctors) {
            genreName.setText(genre.getTitle());

            //  icon.setBackgroundResource(((Doctors) genre).getId());
        }
   /* if (genre instanceof MultiCheckGenre) {
      genreName.setText(genre.getTitle());
      icon.setBackgroundResource(((MultiCheckGenre) genre).getGetId());
    }
    if (genre instanceof SingleCheckGenre) {
      genreName.setText(genre.getTitle());
      icon.setBackgroundResource(((SingleCheckGenre) genre).getGetId());
    }*/
